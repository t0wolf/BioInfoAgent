...
| **Google Gemini** | Gemini 3.1 Pro、Gemini 3 Pro、Gemini 3 Flash | OpenAI 兼容 |
| **xAI Grok** | Grok 4.20、Grok 4.1、Grok 3 | OpenAI 兼容 |
| **DeepSeek** | DeepSeek V4 Pro、DeepSeek R1、DeepSeek Chat | OpenAI 兼容 |
| **小米 MiMo** | MiMo v2.5 Pro、MiMo-7B | OpenAI 兼容 |
| **自定义** | 任意模型 | OpenAI 兼容 |
